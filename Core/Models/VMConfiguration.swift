...
struct VMConfiguration: Codable, Equatable, Sendable {
    ...
    enum Resolution: String, Codable, CaseIterable {
        case low = "480×854", balanced = "540×960", high = "720×1280"
        var width: Int { switch self { case .low: 480; case .balanced: 540; case .high: 720 } }
        var height: Int { switch self { case .low: 854; case .balanced: 960; case .high: 1280 } }
    }
